  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 pb-4 mt-12">
        ...
        <div className="mt-6 p-4 border border-gray-800 rounded-2xl bg-gray-950 flex items-center justify-between">
          <div>
            <h3 className="text-white font-bold text-base">Keywords Browser Notifications</h3>
            <p className="text-gray-400 text-xs mt-1">
              Show popup notifications for new posts containing "cricket" or "science".
            </p>
          </div>
          <Button
            ...
            onClick={async () => {
              try {
                const currentPref = !!user.notificationsEnabled;
